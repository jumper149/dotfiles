...
myKeys = do
    ...
    "M-C-p"                    |/- "MPD: play/pause"
                                ^> spawn "mpc toggle"
    "M-<XF86AudioPlay>"        |/- "| alias: M-C-p"
                                ^> spawn "mpc toggle"
    "<XF86AudioPlay>"          |/- "| alias: M-C-p"
                                ^> spawn "mpc toggle"
    "M-C-o"                    |/- "MPD: stop"
                                ^> spawn "mpc stop"
    "M-<XF86AudioStop>"        |/- "| alias: M-C-o"
                                ^> spawn "mpc stop"
    "<XF86AudioStop>"          |/- "| alias: M-C-o"
                                ^> spawn "mpc stop"
    "M-C-["                    |/- "MPD: next"
                                ^> spawn "mpc next"
    "M-<XF86AudioNext>"        |/- "| alias: M-C-["
                                ^> spawn "mpc next"
    "<XF86AudioNext>"          |/- "| alias: M-C-["
                                ^> spawn "mpc next"
    "M-C-i"                    |/- "MPD: previous"
                                ^> spawn "mpc prev"
    "M-<XF86AudioPrev>"        |/- "| alias: M-C-i"
                                ^> spawn "mpc prev"
    "<XF86AudioPrev>"          |/- "| alias: M-C-i"
                                ^> spawn "mpc prev"

    "M-<Print>"                |/- "take screenshot"
                                ^> spawn "scrot"
    "<Print>"                  |/- "| alias: M-<Print>"
                                ^> spawn "scrot"
...
applyKeys = (`additionalKeysP` (fmap mkUsable $ bind myKeys)) . (`removeKeysP` myRemovedKeys)
